            ...
            <div className="container-create-ticket min-vh-100 overflow-auto">
                ...
                <Container className="custom-form">
                    <Form>
                        <Row>
                            <Col md={6}>
                                ...
                                <Form.Group controlId="formArea">
                                    <Form.Label className="form-label-create-ticket">Área</Form.Label>
                                    <Form.Control
                                        as="select"
                                        value={selectedArea}
                                ...
                                <Form.Group controlId="formDescripcion">
                                    <Form.Label className="form-label-create-ticket">Descripción</Form.Label>
                                    <Form.Control
                                        as="textarea"
                        ...
                        <Row>
                            <Col md={12}>
                                <Button className="btnguardar" variant="primary" onClick={handleSubmit}>
                                    Guardar Ticket
                                </Button>
                            </Col>
                        </Row>
